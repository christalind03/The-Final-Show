...
public class NetworkEnemyStateMachine : NetworkStateManager<NetworkEnemyStateMachine.EEnemyState>
{
    ...
    private void InitializeStates()
    {
        ...
        {
            NetworkEnemyStateMachine.EEnemyState stateMappingKey = stateMapping.Key;
            BaseState<NetworkEnemyStateMachine.EEnemyState> stateMappingValue = stateMapping.Value;

            var stateInstance = (NetworkEnemyState)ScriptableObject.CreateInstance(stateMappingValue.GetType());
